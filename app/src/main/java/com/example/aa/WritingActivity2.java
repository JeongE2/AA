...
public class WritingActivity2 extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                databaseReference.child(board).child(col).child(colcol).push().setValue(writing).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(WritingActivity2.this, "등록되었습니다.", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(WritingActivity2.this, MainActivity.class);
